(function () {
		...
		(function (global, factory) {
		  ...
		  */
		  var _config = {
		    ...
		    animation.render(time, suppressEvents, _reverting && time < 0 && (animation._initted || animation._startAt));
		    _lazyTweens.length && !_reverting && _lazyRender();
		  },
	...
	gsapExports.gsap.registerPlugin(ScrollSmootherExports.ScrollSmoother,MorphSVGPluginExports.MorphSVGPlugin,ScrollTriggerExports.ScrollTrigger);
